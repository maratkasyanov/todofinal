...
export default class App extends React.Component {
  ...
  state = {
    text: [
      { id: 0, name: 'Completed task', done: false, clas: '', display: '', created: this.filling(this.nowDate) },
      { id: 1, name: 'Editing task', done: false, clas: '', display: '', created: this.filling(this.nowDate) },
      { id: 2, name: 'Active task', done: false, clas: '', display: '', created: this.filling(this.nowDate) }]
  }
  ...
  onAdded = (label) => {
    const newitem = {
      id: this.maxid++, name: label, done: false, clas: '', display: '', created: this.filling(new Date())
    }
